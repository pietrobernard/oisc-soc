...
entity dev_UART_v2 is
    ...
    port (
        ...
        --  debug for device 0
        dbg_sdev_0_main: out natural;
        dbg_sdev_0_subbus: out natural;
        dbg_sdev_0_subbus_dev: out natural;
        dbg_sdev_0_subbus_dev_int: out natural;
        --  debug for device 1
        dbg_sdev_1_main: out natural;
        dbg_sdev_1_subbus: out natural;
        dbg_sdev_1_subbus_dev: out natural;
        dbg_sdev_1_subbus_dev_int: out natural;    
        --  other debug        
        dbg_bridge: out natural;
        dbg_bridge_ext: out natural;
        dbg_bridge_int: out natural
    );
end dev_UART_v2;

architecture Behavioral of dev_UART_v2 is
...
begin
    ...
    BUS_BRIDGE: entity work.bus_bridge_v2(Behavioral)
                    generic map (
                        ...
                        dbg_stage_extbus => dbg_bridge_ext,
                        dbg_stage_intbus => dbg_bridge_int
                    );
    ...
    UART_DEV0:  entity work.subdev_UART_dev0_v2(Behavioral)
                    generic map (
                        --  bus topology
                        bus_width => bus_width,
                        data_width => data_width,
                        ...
                        hw_tns => hw_bus_tns,
                        --  debug signals
                        dbg_main => dbg_sdev_0_main,
                        dbg_subbus => dbg_sdev_0_subbus,
                        dbg_subbus_dev => dbg_sdev_0_subbus_dev,
                        dbg_subbus_dev_int => dbg_sdev_0_subbus_dev_int
                    );
    
    --  device 1 is instead an ANSI terminal controller
    UART_DEV1:  entity work.subdev_UART_dev1_v2(Behavioral)
                    generic map (
                        --  bus topology
                        bus_width => bus_width,
                        data_width => data_width,
                        ...
                        hw_tns => hw_bus_tns,
                        --  debug signals
                        dbg_main => dbg_sdev_1_main,
                        dbg_subbus => dbg_sdev_1_subbus,
                        dbg_subbus_dev => dbg_sdev_1_subbus_dev,
                        dbg_subbus_dev_int => dbg_sdev_1_subbus_dev_int
                    );
