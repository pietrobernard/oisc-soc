...
architecture Behavioral of subdev_GPIO_kbd is    
    --  subdev interface
                            ...
                            case (r_stage) is
                                ...
                                when s0 =>
                                    if (c=(t_bef_sample-1)) then
                                        ...
                                        if (s_data_from_port="11100000") then
                                            --  cancello via questo
                                            --sig <= '1';
                                            r_stage <= s1;
                                        else
                                ...
                                when s2 =>
                                    case (ncn) is
                                        when 0 =>
                                            --  primo scancode
                                            kbd_scancodes(0) <= s_data_from_port;
                                            ncn := 1;
                                            sw := 0;
                                            r_jump <= s2;
                                            r_stage <= s1;
                                        ...
                                        when 1 =>
                                            ...
                                            if (((s_data_from_port=kbd_scancodes(0)) and (sw=0)) or ((s_data_from_port=kbd_scancodes(1)) and (sw=1))) then
                                                --  ripetizione del primo scancode
                                                ncn := 1;
                                                r_jump <= s2;
                                                r_stage <= s1;
                                            else
                                                if (s_data_from_port="11110000") then
                                                    ...
                                                    --  nuovo scancode
                                                    if (sw=0) then
                                                        kbd_scancodes(1) <= s_data_from_port;
                                                    else
                                                        kbd_scancodes(0) <= s_data_from_port;
                                                    end if;
                                                    ncn := 2;
                                        ...
                                        when 2 =>
                                            ...
                                            if (((s_data_from_port=kbd_scancodes(1)) and (sw=0)) or ((s_data_from_port=kbd_scancodes(0)) and (sw=1))) then
