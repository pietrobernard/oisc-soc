...
end subdev_I2C_dev0_v2;

architecture Behavioral of subdev_I2C_dev0_v2 is
    --  debug
    ...
    --  state machine
    type t_SM is (s_INIT, s_IDLE, s_REG, s_END, s_VRT_0, s_VRT_1, s_VRT_2, s_VRT_2b, s_VRT_3, s_VRT_4, s_VRT_5, s_VRT_6, s_VRT_7);
                        ...
                        if (sysRstb='0') then
                            ...
                            case (r_stage) is
                                ...
                                when s_IDLE =>
                                    ...
                                    case (cond) is
                                        when "01" =>
                                            ...
                                            if (addr=32768) then
                                                nt := to_integer(unsigned(ss_bus_out_data));
                                                r_stage <= s_END;
                                            else
                                                --  riga aggiunta
                                                nt := 1;
                                ...
                                when s_VRT_1 =>
                                    ...
                                    i2c_packet(0)(7) <= ss_bus_out_cmd;                     --  i2c command
                                ...
                                when s_VRT_3 =>
                                    r_dbg <= 6;
                                    if ((ss_sync_0='1') and (ss_hw_drdy='0')) then
                                        if (pc=(pc_lim-1)) then
                                            --  if this was a write, we must wait an appropriate delay before sending the response
                                            pc := 0;
                                            r_stage <= s_VRT_4;
                                        else
                                            pc := pc + 1;
                                ...
                                when s_VRT_5 =>
                                    r_dbg <= 8;
                                    if ((ss_sync_0='1') and (ss_hw_bus_grant='0')) then
                                        --  all done
                                        nt := 1;
                                        r_stage <= s_IDLE;
                                    else
