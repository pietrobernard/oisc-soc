...
end subdev_UART_dev1;

architecture Behavioral of subdev_UART_dev1 is
    --  subdev interface
...
begin
    --dbg <= r_dbg;
    dbg <= r_dbg_sbus;  --  subbus interface stage
    --dbg <= r_dbg_dev;   --  subbus' dev interface stage
                            ...
                            case (r_stage) is
                                ...
                                when s_VREG_0 =>
                                    ...
                                    if (ss_bus_out_cmd='1') then
                                        ...
                                        cond := '0'&ss_hw_bus_grant&ss_hw_bus_busy;
                                        case (cond) is
                                ...
                                when s_VREG_5 =>
                                    r_dbg <= 16;
                                    if ((ss_hw_bus_grant='0') and (ss_hw_bus_busy='0')) then
                                        r_stage <= s_IDLE;
                                    else
                                        r_stage <= s_VREG_5;
                                    end if;
